...
<body class="container mt-3">
	...
	<p class="float-start">
		...
		<c:if test="${page.number > 0}">
			<a class="btn btn-info" href="/product/page?p=${page.number-1}">Previous</a>
		</c:if>
		
		<c:if test="${page.number < (page.totalPages-1)}">
			<a class="btn btn-info" href="/product/page?p=${page.number+1}">Next</a>
		</c:if>
		
		<a class="btn btn-info" href="/product/page?p=${page.totalPages-1}">Last</a>
	</p>
