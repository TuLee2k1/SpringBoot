...
<body class="container mt-3">
	...
	<p class="float-start mt-3">
		...
		<c:if test="${page.number > 0}">
			<a class="btn btn-primary" href="/product/search-and-page?p=${page.number-1}">Previous</a>
		</c:if>
		
		<c:if test="${page.number < (page.totalPages-1)}">
			<a class="btn btn-primary" href="/product/search-and-page?p=${page.number+1}">Next</a>
		</c:if>
